...
const styles = {
  ...
  sheet: {
    background: '#fff', width: '100%', maxWidth: 480, maxHeight: '78vh', overflowY: 'auto',
    borderRadius: '24px 24px 0 0', padding: '10px 20px 28px',
  },
  handle: { width: 40, height: 4, background: '#E5E7EB', borderRadius: 4, margin: '6px auto 14px' },
  header: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 },
  title: { fontSize: 18, fontWeight: 700, margin: 0 },
  closeBtn: { background: '#F1F2F4', border: 'none', borderRadius: '50%', width: 30, height: 30, fontSize: 14 },
  list: { display: 'flex', flexDirection: 'column', gap: 12 },
  item: { border: '1px solid var(--green-border)', borderRadius: 'var(--radius-md)', padding: 14 },
